 ...
 *    خودش دارد. ۴) هم‌مقیاسی سطر ویرایش و چاپ (ضریب عرض ۵۲۰pt چاپ).
...
class V63_7EditorPrintParityTest {
    ...
    fun `editor line width matches the printed line width`() {
        // V69.0 — چاپ: عرض محتوا 595-2x40=515pt؛ ویرایشگر همان نسبت را با /520f اعمال می‌کند
        assertTrue("/ 520f" in editor)
